...
| 일시       | 변경 내역                                                                                                                                                                                                                |
| ---------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2023.11.29    | - 친구톡 캐러셀 커머스 이미지 업로드 요청 API 추가<br/> - 친구톡 관련 이미지 최대 사이즈 변경(5MB)
| 2023.07.    | 친구톡 관련 이미지 업로드 API 추가<br/> - 친구톡 이미지 업로드 요청<br/> - 친구톡 와이드 이미지 업로드 요청<br/> - 친구톡 와이드 아이템 리스트 이미지 업로드 요청<br/> - 친구톡 캐러셀 이미지 업로드 요청                 
...
### 2.5 친구톡 이미지 업로드 요청
+ 친구톡 이미지 발송 시 사용될 이미지를 업로드 합니다.
+ 제한 사이즈 - 가로 500px 이상, 가로:세로 비율 2:1 이상 3:4 이하
+ 파일형식 및 크기 : jpg, png / 최대 5MB

**POST** /api/v1/image/friendtalk
...
### 2.6 친구톡 와이드 이미지 업로드 요청
+ 친구톡 와이드 발송 시 사용될 이미지를 업로드 합니다.
+ 제한 사이즈 - 가로 800px, 세로 600px
+ 파일형식 및 크기 : jpg, png / 최대 5MB

**POST** /api/v1/image/friendtalk/wide
...
| 키 | 타입 | 필수 | 설명 |
| -------- | -------- | -------- | -------- |
| image_1 | binary | - | 업로드할 이미지 파일 #1 |
| image_2 | binary | - | 업로드할 이미지 파일 #2 |
| image_3 | binary | - | 업로드할 이미지 파일 #3 |
| image_4 | binary | - | 업로드할 이미지 파일 #4 |
...
### 2.8 친구톡 캐러셀 피드 이미지 업로드 요청
+ 친구톡 캐러셀 아이템 리스트 발송 시 사용될 이미지를 업로드 합니다.
+ 캐러셀 리스트 개수에 맞춰서 image_[1~10] 를 사용해서 업로드 합니다
+ 제한 사이즈 - 가로 500px 이상, 가로:세로 비율 2:1 이상 3:4 이하
+ 파일형식 및 크기 : jpg, png / 각 파일 최대 5MB

**POST** /api/v1/image/friendtalk/carousel
...
| image_3 | binary | - | 업로드할 이미지 파일 #3 |
| image_4 | binary | - | 업로드할 이미지 파일 #4 |
| image_5 | binary | - | 업로드할 이미지 파일 #5 |
| image_6 | binary | - | 업로드할 이미지 파일 #6 |
| image_7 | binary | - | 업로드할 이미지 파일 #7 |
| image_8 | binary | - | 업로드할 이미지 파일 #8 |
| image_9 | binary | - | 업로드할 이미지 파일 #9 |
| image_10 | binary | - | 업로드할 이미지 파일 #10 |
...
### 2.9 친구톡 캐러셀 커머스 이미지 업로드 요청
+ 친구톡 캐러셀 커머스 발송 시 사용될 이미지를 업로드 합니다.
+ 업로드한 이미지를 캐러셀 커머스형의 이미지로 사용할 수 있습니다.
+ 캐러셀 인트로 + 캐러셀 리스트 개수에 맞춰서 image_[1~11] 를 사용해서 업로드 합니다
+ 전체 이미지 비율이 동일해야 합니다.
+ 제한 사이즈 - 가로 500px 이상, 가로:세로 비율 2:1 이상 3:4 이하
+ 파일형식 및 크기 : jpg, png / 각 파일 최대 5MB

**POST** /v1/image/friendtalk/carouselCommerce
...
| image_9 | binary | - | 업로드할 이미지 파일 #9 |
| image_10 | binary | - | 업로드할 이미지 파일 #10 |
| image_11 | binary | - | 업로드할 이미지 파일 #11 |
